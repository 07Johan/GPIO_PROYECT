...
set ::env(DESIGN_NAME) gpio_vector
...
set ::env(PNR_SDC_FILE) /foss/designs/openlane_example_counter/src/counter.sdc
set ::env(STA_MACRO_PRIORITIZE_NL) 1
set ::env(SIGNOFF_SDC_FILE) /foss/designs/openlane_example_counter/src/counter.sdc
set ::env(CURRENT_NETLIST) /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/51-openroad-fillinsertion/gpio_vector.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/53-openroad-rcx/nom/gpio_vector.nom.spef \"min_*\" /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/53-openroad-rcx/min/gpio_vector.min.spef \"max_*\" /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/53-openroad-rcx/max/gpio_vector.max.spef"
set ::env(CURRENT_ODB) /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/52-odb-cellfrequencytables/gpio_vector.odb
set ::env(SAVE_SDC) /foss/designs/openlane_example_counter/runs/RUN_2025-05-15_18-37-38/54-openroad-stapostpnr/gpio_vector.sdc
